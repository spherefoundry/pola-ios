...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        _cardCountLimit = kBPStackViewDefaultCardCountLimit;
        ...
        _layoutContext.cardCountLimit = _cardCountLimit;
...
- (BOOL)addCard:(UIView *)cardView {
    ...
    UIView *toBeRemovedCard = _cards.count > _cardCountLimit ? _cards[0] : nil;
